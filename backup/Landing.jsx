...
import { useAuth } from '../client/src/context/AuthContext'; // Assuming useAuth provides isAuthenticated

import AuthModal from '../client/src/components/auth/AuthModal';
import LoginForm from '../client/src/components/auth/LoginForm';
import SignUpForm from '../client/src/components/auth/SignUpForm';
import OtpForm from '../client/src/components/auth/OtpForm';
import ProfileButton from '../client/src/components/nav/ProfileButton';
import Sidebar from '../client/src/components/nav/Sidebar'; // Assuming Sidebar component
