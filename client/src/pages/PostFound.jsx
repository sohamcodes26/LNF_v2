          ...
          <div className="bg-white w-full p-8 rounded-2xl shadow-lg border border-gray-200/80">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              <div>
                ...
                <input id="item-title" type="text" value={itemTitle} onChange={(e) => setItemTitle(e.target.value)} placeholder="e.g., iPhone 14 Pro, Blue Backpack" className="w-full px-4 py-2 text-gray-800 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required />
              </div>
      ...
      <div className="hidden md:flex flex-col justify-center bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100 p-12 lg:p-20">
        <div className="max-w-md">
          ...
          <ul className="space-y-6 text-gray-600">
            ...
            <li className="flex gap-4"><div className="font-bold text-blue-500">3.</div><div><h3 className="font-semibold text-gray-800">Mention the Location</h3><p>Be specific about where you found the item (e.g., "on a bench near the library entrance" or "in room 204 of the science building").</p></div></li>
          </ul>
        </div>
      </div>
    </main>
